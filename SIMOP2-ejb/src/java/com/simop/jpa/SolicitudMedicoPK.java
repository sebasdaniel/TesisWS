 ...
 */
@Embeddable
public class SolicitudMedicoPK implements Serializable {
    ...
    public SolicitudMedicoPK() {
    }

    public SolicitudMedicoPK(int medicoCedulaMedico, int pacienteNumid, String pacienteTipoid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SolicitudMedicoPK)) {
            return false;
        }
        SolicitudMedicoPK other = (SolicitudMedicoPK) object;
    ...
    public String toString() {
        return "com.simop.jpa.SolicitudMedicoPK[ medicoCedulaMedico=" + medicoCedulaMedico + ", pacienteNumid=" + pacienteNumid + ", pacienteTipoid=" + pacienteTipoid + " ]";
    }
